    ...
    ***************************************************************************** */
    ...
    var NzIconService = /** @class */ (function (_super) {
        ...
        function NzIconService(rendererFactory, sanitizer, nzConfigService, handler, _document, icons) {
            ...
            _this.addIcon.apply(_this, __spreadArray(__spreadArray([], __read(NZ_ICONS_USED_BY_ZORRO)), __read((icons || []))));
            _this.configDefaultTwotoneColor();
            _this.configDefaultTheme();
            return _this;
        }
        NzIconService.prototype.ngOnDestroy = function () {
    ...
    NzIconService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NzIconService_Factory() { return new NzIconService(i0__namespace.ɵɵinject(i0__namespace.RendererFactory2), i0__namespace.ɵɵinject(i1__namespace.DomSanitizer), i0__namespace.ɵɵinject(i2__namespace.NzConfigService), i0__namespace.ɵɵinject(i3__namespace.HttpBackend, 8), i0__namespace.ɵɵinject(i4__namespace.DOCUMENT, 8), i0__namespace.ɵɵinject(NZ_ICONS, 8)); }, token: NzIconService, providedIn: "root" });
    ...
    var NzIconDirective = /** @class */ (function (_super) {
        ...
        function NzIconDirective(ngZone, elementRef, iconService, renderer, iconPatch) {
        ...
        NzIconDirective.prototype.ngOnDestroy = function () {
            this.destroy$.next();
        };
        /**
        ...
        NzIconDirective.prototype.changeIcon2 = function () {
            ...
            this.ngZone.runOutsideAngular(function () {
                rxjs.from(_this._changeIcon())
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function (svgOrRemove) {
                    if (svgOrRemove) {

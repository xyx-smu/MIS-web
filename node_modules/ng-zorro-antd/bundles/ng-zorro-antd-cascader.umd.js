(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NzCascaderComponent = /** @class */ (function () {
        function NzCascaderComponent(cascaderService, nzConfigService, ngZone, cdr, i18nService, elementRef, renderer, directionality, noAnimation) {
        ...
        NzCascaderComponent.prototype.ngOnInit = function () {
            ...
            this.directionality.change.pipe(operators.takeUntil(this.destroy$)).subscribe(function () {
        ...
        NzCascaderComponent.prototype.setupKeydownListener = function () {
            var _this = this;
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.el, 'keydown')
                    ...
                    if (!_this.menuVisible && keyCode !== keycodes.BACKSPACE && keyCode !== keycodes.ESCAPE) {
                        // The `setMenuVisible` runs `detectChanges()`, so we don't need to run `markForCheck()` additionally.
                        return _this.ngZone.run(function () { return _this.setMenuVisible(true); });
                    }
                    // Make these keys work as default in searching mode.
                    if (_this.inSearchingMode && (keyCode === keycodes.BACKSPACE || keyCode === keycodes.LEFT_ARROW || keyCode === keycodes.RIGHT_ARROW)) {
                        return;
                    }
                    ...
                    _this.ngZone.run(function () {
                        ...
                        if (keyCode === keycodes.DOWN_ARROW) {
                            _this.moveUpOrDown(false);
                        }
                        else if (keyCode === keycodes.UP_ARROW) {
                            _this.moveUpOrDown(true);
                        }

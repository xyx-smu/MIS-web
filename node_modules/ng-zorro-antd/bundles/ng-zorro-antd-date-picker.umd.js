(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DateRangePopupComponent = /** @class */ (function () {
        function DateRangePopupComponent(datePickerService, cdr, ngZone, host) {
            var _this = this;
        ...
        DateRangePopupComponent.prototype.ngOnInit = function () {
            ...
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.host.nativeElement, 'mousedown')
    ...
    var NzDatePickerComponent = /** @class */ (function () {
        ...
        NzDatePickerComponent.prototype.ngAfterViewInit = function () {
            ...
            this.datePickerService.inputPartChange$.pipe(operators.takeUntil(this.destroyed$)).subscribe(function (partType) {
                if (partType) {
        ...
        NzDatePickerComponent.prototype.ngOnInit = function () {
            ...
            this.datePickerService.valueChange$.pipe(operators.takeUntil(this.destroyed$)).subscribe(function () {

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/bidi'), require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('ng-zorro-antd/icon'), require('rxjs'), require('@angular/cdk/keycodes'), require('@angular/cdk/portal'), require('rxjs/operators'), require('ng-zorro-antd/core/overlay'), require('ng-zorro-antd/core/util')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/mention', ['exports', '@angular/cdk/bidi', '@angular/cdk/overlay', '@angular/common', '@angular/core', '@angular/forms', 'ng-zorro-antd/icon', 'rxjs', '@angular/cdk/keycodes', '@angular/cdk/portal', 'rxjs/operators', 'ng-zorro-antd/core/overlay', 'ng-zorro-antd/core/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"].mention = {}), global.ng.cdk.bidi, global.ng.cdk.overlay, global.ng.common, global.ng.core, global.ng.forms, global["ng-zorro-antd"].icon, global.rxjs, global.ng.cdk.keycodes, global.ng.cdk.portal, global.rxjs.operators, global["ng-zorro-antd"].core.overlay, global["ng-zorro-antd"].core.util));
})(this, (function (exports, bidi, overlay$1, common, core, forms, icon, rxjs, keycodes, portal, operators, overlay, util) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzMentionComponent = /** @class */ (function () {
        function NzMentionComponent(ngZone, ngDocument, cdr, overlay, viewContainerRef, nzMentionService) {
            this.ngZone = ngZone;
        ...
        NzMentionComponent.prototype.ngAfterViewInit = function () {
            var _this = this;
            this.items.changes
                .pipe(operators.startWith(this.items), operators.switchMap(function () {
                var items = _this.items.toArray();
                // Caretaker note: we explicitly should call `subscribe()` within the root zone.
                // `runOutsideAngular(() => fromEvent(...))` will just create an observable within the root zone,
                // but `addEventListener` is called when the `fromEvent` is subscribed.
                return new rxjs.Observable(function (subscriber) { return _this.ngZone.runOutsideAngular(function () { return rxjs.merge.apply(void 0, __spreadArray([], __read(items.map(function (item) { return rxjs.fromEvent(item.nativeElement, 'mousedown'); })))).subscribe(subscriber); }); });
            }))
        ...
        NzMentionComponent.prototype.resetCursorMention = function () {
            ...
            while (i >= 0) {
                ...
                var endPos = value.indexOf(NZ_MENTION_CONFIG.split, selectionStart) > -1
        ...
        NzMentionComponent.prototype.updatePositions = function () {
            ...
            if (this.nzPlacement === 'bottom') {
                this.positionStrategy.withPositions(__spreadArray([], __read(overlay.DEFAULT_MENTION_BOTTOM_POSITIONS)));
            }
            if (this.nzPlacement === 'top') {
                this.positionStrategy.withPositions(__spreadArray([], __read(overlay.DEFAULT_MENTION_TOP_POSITIONS)));
            }
        ...
        NzMentionComponent.prototype.subscribeOverlayOutsideClick = function () {
            ...
            return rxjs.merge(this.overlayRef.outsidePointerEvents(), rxjs.fromEvent(this.ngDocument, 'touchend')).subscribe(function (event) {
                ...
                if (_this.isOpen &&
                    ...
                    !((_a = _this.overlayRef) === null || _a === void 0 ? void 0 : _a.overlayElement.contains(clickTarget))) {
                    _this.closeDropdown();
                }
            });
        };

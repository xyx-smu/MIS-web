(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"]["switch"] = {}), global.ng.cdk.a11y, global.ng.cdk.bidi, global.ng.cdk.keycodes, global.ng.core, global.ng.forms, global.rxjs, global.rxjs.operators, global["ng-zorro-antd"].core.config, global["ng-zorro-antd"].core.util, global.ng.common, global["ng-zorro-antd"].core.outlet, global["ng-zorro-antd"].core.wave, global["ng-zorro-antd"].icon));
})(this, (function (exports, a11y, bidi, keycodes, core, forms, rxjs, operators, config, util, common, outlet, wave, icon) { 'use strict';
    ...
    var NzSwitchComponent = /** @class */ (function () {
        ...
        NzSwitchComponent.prototype.ngOnInit = function () {
            ...
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.host.nativeElement, 'click')
                ...
                rxjs.fromEvent(_this.switchElement.nativeElement, 'keydown')
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function (event) {
                    if (_this.nzControl || _this.nzDisabled || _this.nzLoading) {
                        return;
                    ...
                    if (keyCode !== keycodes.LEFT_ARROW && keyCode !== keycodes.RIGHT_ARROW && keyCode !== keycodes.SPACE && keyCode !== keycodes.ENTER) {
                        return;
                    }
                    event.preventDefault();
                    _this.ngZone.run(function () {

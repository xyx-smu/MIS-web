(function (global, factory) {
...
})(this, (function (exports, bidi, platform, scrolling, common, core, forms, button, resizeObserver, checkbox, outlet, dropdown, empty, i18n, icon, menu, pagination, radio, spin, rxjs, operators, config, logger, services, util) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzFilterTriggerComponent = /** @class */ (function () {
        function NzFilterTriggerComponent(nzConfigService, ngZone, cdr, destroy$) {
        ...
        NzFilterTriggerComponent.prototype.ngOnInit = function () {
            var _this = this;
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.nzDropdown.nativeElement, 'click')
    ...
    NzFilterTriggerComponent.propDecorators = {
        ...
        nzDropdown: [{ type: core.ViewChild, args: [dropdown.NzDropDownDirective, { static: true, read: core.ElementRef },] }]
    };
    __decorate([
        util.InputBoolean()
    ...
    var NzTableFixedRowComponent = /** @class */ (function () {
        ...
        NzTableFixedRowComponent.prototype.ngOnInit = function () {
            if (this.nzTableStyleService) {
                ...
                hostWidth$.pipe(operators.takeUntil(this.destroy$)).subscribe(this.hostWidth$);
            }
        };
    ...
    NzTableFixedRowComponent.propDecorators = {
        tdElement: [{ type: core.ViewChild, args: ['tdElement', { static: true },] }]
    };
    ...
    var NzTableComponent = /** @class */ (function () {
        ...
        NzTableComponent.prototype.ngOnInit = function () {
            ...
            rxjs.combineLatest([total$, this.templateMode$])
                .pipe(operators.map(function (_b) {
                var _c = __read(_b, 2), total = _c[0], templateMode = _c[1];
                return total === 0 && !templateMode;
        ...
        NzTableComponent.prototype.ngOnChanges = function (changes) {
            var nzScroll = changes.nzScroll, nzPageIndex = changes.nzPageIndex, nzPageSize = changes.nzPageSize, nzFrontPagination = changes.nzFrontPagination, nzData = changes.nzData, nzWidthConfig = changes.nzWidthConfig, nzNoResult = changes.nzNoResult, nzTemplateMode = changes.nzTemplateMode;
            if (nzPageIndex) {

...
export declare class NzResultComponent implements OnChanges, OnDestroy, OnInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzResultComponent, [null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzResultComponent, "nz-result", ["nzResult"], { "nzStatus": "nzStatus"; "nzIcon": "nzIcon"; "nzTitle": "nzTitle"; "nzSubTitle": "nzSubTitle"; "nzExtra": "nzExtra"; }, {}, never, ["[nz-result-icon]", "div[nz-result-title]", "div[nz-result-subtitle]", "nz-result-content, [nz-result-content]", "div[nz-result-extra]"]>;
}

...
export declare class BaseModalContainerComponent extends BasePortalOutlet implements OnDestroy {
    ...
    constructor(ngZone: NgZone, elementRef: ElementRef, focusTrapFactory: FocusTrapFactory, cdr: ChangeDetectorRef, render: Renderer2, overlayRef: OverlayRef, nzConfigService: NzConfigService, config: ModalOptions, document?: NzSafeAny, animationType?: string | undefined);
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<BaseModalContainerComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<BaseModalContainerComponent, never, never, {}, {}, never>;
}

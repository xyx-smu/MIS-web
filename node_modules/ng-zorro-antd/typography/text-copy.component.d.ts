...
export declare class NzTextCopyComponent implements OnInit, OnDestroy, OnChanges {
    ...
    private updateIcons;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzTextCopyComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzTextCopyComponent, "nz-text-copy", ["nzTextCopy"], { "icons": "icons"; "text": "text"; "tooltips": "tooltips"; }, { "textCopy": "textCopy"; }, never, never>;
}

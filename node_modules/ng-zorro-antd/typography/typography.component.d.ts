...
export declare class NzTypographyComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NzTypographyComponent, [null, null, null, null, null, null, null, null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NzTypographyComponent, "  nz-typography,  [nz-typography],  p[nz-paragraph],  span[nz-text],  h1[nz-title], h2[nz-title], h3[nz-title], h4[nz-title]  ", ["nzTypography"], { "nzCopyable": "nzCopyable"; "nzEditable": "nzEditable"; "nzDisabled": "nzDisabled"; "nzExpandable": "nzExpandable"; "nzEllipsis": "nzEllipsis"; "nzCopyTooltips": "nzCopyTooltips"; "nzCopyIcons": "nzCopyIcons"; "nzEditTooltip": "nzEditTooltip"; "nzEditIcon": "nzEditIcon"; "nzEllipsisRows": "nzEllipsisRows"; "nzContent": "nzContent"; "nzType": "nzType"; "nzCopyText": "nzCopyText"; "nzSuffix": "nzSuffix"; }, { "nzContentChange": "nzContentChange"; "nzCopy": "nzCopy"; "nzExpandChange": "nzExpandChange"; "nzOnEllipsis": "nzOnEllipsis"; }, never, ["*"]>;
}
